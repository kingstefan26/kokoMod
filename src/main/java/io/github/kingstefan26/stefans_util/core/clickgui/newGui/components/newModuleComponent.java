...
import io.github.kingstefan26.stefans_util.core.clickgui.newGui.components.subComponents.*;
...
public class newModuleComponent extends newComponent {
    ...
    public newModuleComponent(Module mod, newFrame parent, int offset) {
        this.mod = mod;
        this.parent = parent;
        this.offset = offset;
        ...
        this.subcomponents.add(new newKeybind(this, opY));
