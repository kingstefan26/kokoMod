...
public class localDecoratorManager {
    ...
    public localDecoratorManager(basicModule parent, decoratorInterface... decorators){
        ...
        for(decoratorInterface I : decorators){
            ...
            if(I instanceof onoffMessageDecorator) onoffMessageDecorator = (io.github.kingstefan26.stefans_util.core.module.moduleDecorators.impl.onoffMessageDecorator) I;
            if(I instanceof presistanceDecorator) presistanceDecorator = (io.github.kingstefan26.stefans_util.core.module.moduleDecorators.impl.presistanceDecorator) I;
            if(I instanceof visibleDecorator) visibleDecorator = (io.github.kingstefan26.stefans_util.core.module.moduleDecorators.impl.visibleDecorator) I;
