...
//				-1);
		this.p1.drawStringS(
				...
				-1);
//		GL11.glPopMatrix();
		Component.drawRect(parent.parent.getX() + 3 + 4, parent.parent.getY() + offset + 3, parent.parent.getX() + 9 + 4, parent.parent.getY() + offset + 9, 0xFF999999);
		if(this.op.getValBoolean()) {
			Component.drawRect(parent.parent.getX() + 4 + 4,
