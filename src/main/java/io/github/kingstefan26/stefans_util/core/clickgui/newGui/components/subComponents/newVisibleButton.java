...
public class newVisibleButton extends newComponent { // Remove this class if you don't want it (it's kinda useless)
	...
	public newVisibleButton(newModuleComponent button, Module mod, int offset) {
		this.parent = button;
		this.mod = mod;
