...
public class newSliderNoDecimal extends newComponent {

	private boolean hovered;

	private SliderNoDecimalSetting set;
	...
	public newSliderNoDecimal(SliderNoDecimalSetting value, newModuleComponent button, int offset) {
		this.set = value;
		this.parent = button;
